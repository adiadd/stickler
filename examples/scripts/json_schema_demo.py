...
def custom_extensions_example():
    ...
    document_schema = {
        ...
        "properties": {
            ...
            "content": {"type": "string", "x-stickler-comparator": "fuzzy"},
            "priority": {
                "type": "integer",
...
def real_world_api_schema_example():
    ...
    ground_truth_json = {
        ...
        "metadata": {"timestamp": "2024-01-15T10:30:00Z", "request_id": "req-abc-123"},
    }
...
def advanced_extensions_and_refs_example():
    ...
    ground_truth_json = {
        ...
        "customer": {
            "name": "John Smith",
            "address": {"street": "123 Main Street", "city": "Springfield"},
        },
        "shipping_address": {"street": "456 Oak Avenue", "city": "Springfield"},
        "total_amount": 299.99,
        "items": [
