...
def demo_html_report():
    ...
    gt_product1 = Product(name="Wireless Mouse", price=25.99, category="Electronics")
    ...
    gt_product2 = Product(
        name="Gaming Keyboard", price=89.99, category="Computer Accessories"
    )
...
if __name__ == "__main__":
    ...
    print("\n🎉 Demo completed!")
    print(
        "Check the generated HTML report for a comprehensive view of evaluation results."
    )
