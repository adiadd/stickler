...
class VisualizationEngine:
    ...
    def generate_field_performance_chart(
        self, field_metrics: Dict[str, Any], config: ReportConfig
    ) -> str:
        """
        ...
        for field_name, metrics in field_metrics.items():
            if isinstance(metrics, dict):
                ...
                if isinstance(f1_score, (int, float)):
                    ...
                    color = ColorUtils.get_performance_color(
                        f1_score, config.color_thresholds
                    )
    ...
    def generate_field_performance_table(
        self, field_metrics: Dict[str, Any], config: ReportConfig
    ) -> str:
        """
    ...
    def generate_confusion_matrix_heatmap(
        self, cm_data: Dict[str, Any], config: Any
    ) -> str:
        """
