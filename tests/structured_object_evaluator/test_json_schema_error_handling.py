...
class TestBooleanExtensionValidation:
    ...
    def test_aggregate_non_boolean_raises_error(self):
        ...
        schema = {
            "type": "object",
            "properties": {
                "name": {"type": "string", "x-aws-stickler-aggregate": "false"}
            },
        }

        with pytest.raises(
            ValueError, match="x-aws-stickler-aggregate must be a boolean"
        ):
            StructuredModel.from_json_schema(schema)
    ...
    def test_aggregate_integer_raises_error(self):
        ...
        schema = {
            "type": "object",
            "properties": {"name": {"type": "string", "x-aws-stickler-aggregate": 0}},
        }
...
class TestErrorMessageQuality:
    ...
    def test_boolean_error_includes_type(self):
        ...
        schema = {
            "type": "object",
            "properties": {
                "name": {"type": "string", "x-aws-stickler-aggregate": "yes"}
            },
        }
